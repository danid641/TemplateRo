    ...
    if (e(".dashboard-page").length) {
        function a(a) {
            ...
            if (l.length) {
                ...
                function n(e) {
                    return ["line" === a.config.type ? l[e].borderColor : l[0].backgroundColor[e], o ? l[0].data[e] : "", "line" === a.config.type ? l[e].label : t.labels[e]]
                }
                for (var s = 0; s < r; ++s) e.push('<li><div><span style="background-color:' + n(s)[0] + '"></span> <span>' + n(s)[2] + "</span>"), e.push("</div>"), e.push("<span>" + n(s)[1] + "</span>"), e.push("</li>");
                return e.push("</ul>"), e.join("")
            }
        }
        Chart.defaults.global.defaultFontFamily = "'Work Sans', sans-serif", Chart.defaults.global.defaultFontColor = "#898b96", Chart.defaults.global.defaultFontSize = 16;
        var t = {
            ...
            n = new Chart(r, {
                ...
                data: {
                    datasets: [{
                        ...
                        backgroundColor: ["#34bfa3", "#f4516c", "#36a3f7", "#ffcd56", "#ff9f40"]
                    }],
...
! function() {
    ...
    a.hide(), r.on("click", function(e) {
        e.preventDefault(), $(this).parents(".media").siblings(".reply-comment").toggle().find("textarea").focus()
    ...
    p.on("click", function() {
        ...
        for (var i = e.target.files, t = $(".attached"), o = 0; i.length > o; o++) t.append("<p>" + i[o].name + '<span class="icon-close"></span></p>')
    ...
    u.owlCarousel({
        items: 1,
        autoplay: !1
    }), i(".prod_slide_prev", ".prod_slide_next", u), $(".testimonial-slider").owlCarousel({
        items: 1,
        dots: !1,
        nav: !0,
    ...
    }), i(".follow_feed_nav .nav_right", ".follow_feed_nav .nav_left", f), $(".partners").owlCarousel({
        items: 5,
        autoplay: !0,
        responsive: {
            0: {
    ...
    w.slick({
    ...
    }), v = w, g = $(".thumb-nav .nav-left"), h = $(".thumb-nav .nav-right"), g.on("click", function() {
        v.slick("slickNext")
    }), h.on("click", function() {
        v.slick("slickPrev")
        ...
        $.get(e, function(e) {
            ...
            void 0 !== o && (i = i.attr("id", o)), void 0 !== s && (i = i.attr("class", s + " replaced-svg")), i = i.removeAttr("xmlns:a"), t.replaceWith(i)
        }, "xml")
    ...
    k.hide(), $('input[name="filter_opt"]').on("change", function() {
        ...
        iframe: {
            ...
            patterns: {
                ...
                vimeo: {
                    index: "vimeo.com/",
                    id: function(e) {
                        var i = e.match(/(https?:\/\/)?(www.)?(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/);
...
! function(e) {
    "use strict";
    0 < jQuery("#map").length && google.maps.event.addDomListener(window, "load", function() {
        var e = new google.maps.LatLng(54.085533, -.194593),
            t = {
                center: e,
                zoom: 16,
                scrollwheel: !1,
