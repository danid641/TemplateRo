...
<?php require_once("../../../inc/menu.php"); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-contents">
                        <h2 class="page-title">Header Styles</h2>
    ...
    <section class="section--padding">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 m-bottom-65">
                    <div class="feature_title">
                        <h3>Header Style 01</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="menu-fullwidth">
                                <div class="logo-wrapper">
                                    <div class="logo logo-top">
                                        <a href="index.html"><img src="https://localhost/assets/img/logo/mini-logo_120x120.png" alt="logo image" class="img-fluid"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="author-area">
                                                    ...
                                                    <div class="dropdown notification--dropdown">
                                                        ...
                                                        <div class="notifications_module">
                                                            <div class="notification">
                                                                <div class="notification__info">
                                                                    <div class="info_avatar">
                                                                        <img src="assets/img/logo/notification_head.png" alt="">
                                                                    </div>
                                                                    <div class="info">
                                                                        <p>
                                                            ...
                                                            <div class="notification">
                                                                <div class="notification__info">
                                                                    <div class="info_avatar">
                                                                        <img src="assets/img/logo/notification_head2.png" alt="">
                                                                    </div>
                                                                    <div class="info">
                                                                        <p>
                                                            ...
                                                            <div class="notification">
                                                                <div class="notification__info">
                                                                    <div class="info_avatar">
                                                                        <img src="assets/img/logo/notification_head3.png" alt="">
                                                                    </div>
                                                                    <div class="info">
                                                                        <p>
                                                            ...
                                                            <div class="notification">
                                                                <div class="notification__info">
                                                                    <div class="info_avatar">
                                                                        <img src="assets/img/logo/notification_head4.png" alt="">
                                                                    </div>
                                                                    <div class="info">
                                                                        <p>
                                                                            <span>Anderson</span> added to Favourite
                                                    ...
                                                    <div class="dropdown messaging--dropdown">
                                                        ...
                                                        <div class="messages">
                                                            ...
                                                            <a href="message.html" class="message recent">
                                                                <div class="message__actions_avatar">
                                                                    <div class="avatar">
                                                                        <img src="assets/img/logo/notification_head5.png" alt="">
                                                                    </div>
                                                                </div>
                                                                <!-- end /.actions -->
                                                                <div class="message_data">
                                                            ...
                                                            <div class="cart_list">
                                                                <div class="cart_product">
                                                                    <div class="product__info">
                                                                        <div class="thumbn">
                                                                            <img src="assets/img/logo/capro1.jpg" alt="cart product thumbnail">
                                                                        </div>
                                                                        <div class="info">
                                                                            ...
                                                                            <div class="cat">
                                                                                <a href="#">
                                                                                    <img src="assets/img/logo/catword.png" alt="">Wordpress</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="cart_product">
                                                                    <div class="product__info">
                                                                        <div class="thumbn">
                                                                            <img src="assets/img/logo/capro2.jpg" alt="cart product thumbnail">
                                                                        </div>
                                                                        <div class="info">
                                        ...
                                        <div class="author-author__info has_dropdown">
                                            <div class="author__avatar online">
                                                <img src="assets/img/logo/user-avater.png" alt="user avatar" class="rounded-circle">
                                            </div>
                                        ...
                                        <div class="offcanvas-menu closed">
                                            ...
                                            <div class="author-author__info">
                                                <div class="author__avatar v_middle">
                                                    <img src="assets/img/logo/user-avater.png" alt="user avatar">
                                                </div>
                                            </div>
                                            <!--end /.author-author__info-->
                                            <div class="author__notification_area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 m-bottom-65 m-top-65">
                    <div class="feature_title">
                        <h3>Header Style 02</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="menu-fullwidth">
                                ...
                                <div class="menu-container">
                                    <div class="d_menu">
                                        <nav class="navbar navbar-expand-lg mainmenu__menu">
                                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar_collapse_2" aria-controls="navbar_collapse_2" aria-expanded="false" aria-label="Toggle navigation">
                                                <span class="navbar-toggler-icon icon-menu"></span>
                                            </button>
                                            <!-- Collect the nav links, forms, and other content for toggling -->
        ...
        <!-- end /.menu-area -->
        <!-- START MENU AREA LIGHT -->
        <div class="container m-top-60">
            <div class="row">
                <div class="col-md-12 m-bottom-65">
                    <div class="feature_title">
                        <h3>Header Style Light</h3>
                    </div>
                </div>
            </div>
        </div>
