...
<body class="preload">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-contents">
                        <h2 class="page-title">Author Badges</h2>
    ...
    <div class="badge-single">
        <img src="img/svg/author_rank_bronze.svg" alt="" class="svg">
        <h4>Bronze Author</h4>
    ...
    <div class="badge-single">
        <img src="img/svg/author_rank_golden.svg" alt="" class="svg">
        <h4>Golden Author</h4>
    ...
    <div class="badge-single">
        <img src="img/svg/author_rank_diamond.svg" alt="" class="svg">
        <h4>Diamond Author</h4>
    ...
    <section class="badges community-badges">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
    ...
    <div class="badge-single">
        <img src="img/svg/author_level_3.svg" alt="" class="svg">
        <h4>Author Level</h4>
        <p>Sold more than $50,000 on MartPlace</p>
    </div>
    ...
    <div class="badge-single">
        <img src="img/svg/affiliate_level_1.svg" alt="" class="svg">
        <h4>Affiliate Level</h4>
        <p>Has referred 50+ members on MartPlace</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/collection_level_1.svg" alt="" class="svg">
        <h4>Collection Level</h4>
        <p>Has collected 20+ items on MartPlace</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/contest_winner.svg" alt="" class="svg">
        <h4>Contest Winner</h4>
        <p>Won a competition in the MartPlace</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/copyright.svg" alt="" class="svg">
        <h4>Copyright</h4>
        <p>Protected the Market against copyright violations</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/country.svg" alt="" class="svg">
        <h4>United States</h4>
        <p>Country of Location: United States</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/exclusive_author.svg" alt="" class="svg">
        <h4>Exclusive Author</h4>
        <p>Sells items exclusively on MartPlace</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/featured_author.svg" alt="" class="svg">
        <h4>Featured Author</h4>
        <p>Made it to the Authors&#39; Hall of Fame</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/featured_item.svg" alt="" class="svg">
        <h4>Featured Item</h4>
        <p>Had an item featured on MartPlace</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/forum_superstar.svg" alt="" class="svg">
        <h4>Forum Superstar</h4>
        <p>Provided great contribution to our forums</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/members_years.svg" alt="" class="svg">
        <h4>Member for 2 Years</h4>
        <p>Has been a member of the market for 2 years.</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/recommended.svg" alt="" class="svg">
        <h4>Recommendation</h4>
        <p>This author has a 100% positive recomendations.</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/support.svg" alt="" class="svg">
        <h4>Author Support</h4>
        <p>The author offers support for their items.</p>
    </div>

                        
    <div class="badge-single">
        <img src="img/svg/top_seller.svg" alt="" class="svg">
        <h4>Top Seller</h4>
        <p>Had an item become a Monthly Best Sellers.</p>
    </div>

                    </div><!-- ends: .author-badges -->
                </div>
            </div>
        </div>
    </section><!-- ends: .community-badges -->

    <section class="badges community-badges bgcolor">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/author_level_3.svg" alt="" class="svg locked">
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/affiliate_level_1.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Affiliate Level</h4>
        <p>Has referred 50+ members on MartPlace</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/collection_level_1.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Collection Level</h4>
        <p>Has collected 20+ items on MartPlace</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/contest_winner.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Contest Winner</h4>
        <p>Won a competition in the MartPlace</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/copyright.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Copyright</h4>
        <p>Protected the Market against copyright violations</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/country.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>United States</h4>
        <p>Country of Location: United States</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/exclusive_author.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Exclusive Author</h4>
        <p>Sells items exclusively on MartPlace</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/featured_author.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Featured Author</h4>
        <p>Made it to the Authors&#39; Hall of Fame</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/featured_item.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Featured Item</h4>
        <p>Had an item featured on MartPlace</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/forum_superstar.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Forum Superstar</h4>
        <p>Provided great contribution to our forums</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/members_years.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Member for 2 Years</h4>
        <p>Has been a member of the market for 2 years.</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/recommended.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Recommendation</h4>
        <p>This author has a 100% positive recomendations.</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/support.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Author Support</h4>
        <p>The author offers support for their items.</p>
    ...
    <div class="badge-single">
        <div class="svg_wrapper">
            <img src="img/svg/top_seller.svg" alt="" class="svg locked">
            <span class="fa fa-lock"></span>
        </div>
        <h4>Top Seller</h4>
        <p>Had an item become a Monthly Best Sellers.</p>
